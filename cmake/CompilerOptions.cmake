...
if(CMAKE_BUILD_TYPE STREQUAL "Release")
	if(CMAKE_CXX_COMPILER_ID MATCHES "GNU|Clang")
		...
		set(CMAKE_CXX_FLAGS_RELEASE "-O3 -DNDEBUG -ffunction-sections -fdata-sections -falign-functions=32 -falign-loops=32 -falign-jumps=32 -falign-labels=32 -fvisibility=hidden -fvisibility-inlines-hidden")
		if(NOT EMSCRIPTEN)
			set(CMAKE_EXE_LINKER_FLAGS_RELEASE "${CMAKE_EXE_LINKER_FLAGS_RELEASE} -flto=auto -O3 -Wl,-O3 -Wl,--as-needed -Wl,--gc-sections -s")
		else()
			set(CMAKE_EXE_LINKER_FLAGS_RELEASE "${CMAKE_EXE_LINKER_FLAGS_RELEASE} -flto=auto -O3 -Wl,-O3 -Wl,--gc-sections -s")
		endif()
	endif()
endif()
...
if(EMSCRIPTEN)
	...
	set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -sUSE_PTHREADS")
