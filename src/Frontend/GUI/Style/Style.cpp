...
void SetupImGuiStyle() {
    ...
    style.Colors[ImGuiCol_TextDisabled] = ImVec4(0.2745098173618317F, 81.0F / 255.0F, 0.4509803950786591F, 1.0F); // Its a fraction because LINT thought it was an inverse of PI and kept crying about it because I didnt use the PI constant from <cmath>
    ...
    style.Colors[ImGuiCol_ButtonActive] = ImVec4(0.15F, 0.25F, 0.45F, 1.0F);
