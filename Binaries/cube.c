...
const int SIN_TABLE[256] = {
     ...
     97, 103, 109, 114, 120, 125, 131, 136, 141, 146, 150, 155, 159, 164, 168, 172,
    176, 180, 183, 187, 190, 193, 196, 198, 201, 203, 206, 208, 210, 212, 213, 215,
    216, 217, 218, 219, 219, 220, 220, 220, 220, 219, 219, 218, 217, 216, 215, 213,
    212, 210, 208, 206, 203, 201, 198, 196, 193, 190, 187, 183, 180, 176, 172, 168,
    164, 159, 155, 150, 146, 141, 136, 131, 125, 120, 114, 109, 103,  97,  92,  86,
     80,  74,  68,  62,  56,  49,  43,  37,  31,  25,  18,  12,   6,   0,  -6, -12,
    -18, -25, -31, -37, -43, -49, -56, -62, -68, -74, -80, -86, -92, -97,-103,-109,
   -114,-120,-125,-131,-136,-141,-146,-150,-155,-159,-164,-168,-172,-176,-180,-183,
   -187,-190,-193,-196,-198,-201,-203,-206,-208,-210,-212,-213,-215,-216,-217,-218,
   -219,-219,-220,-220,-220,-220,-219,-219,-218,-217,-216,-215,-213,-212,-210,-208,
   -206,-203,-201,-198,-196,-193,-190,-187,-183,-180,-176,-172,-168,-164,-159,-155,
   -150,-146,-141,-136,-131,-125,-120,-114,-109,-103, -97, -92, -86, -80, -74, -68,
    -62, -56, -49, -43, -37, -31, -25, -18, -12,  -6
};
...
void rotate_all(unsigned char ax, unsigned char ay, unsigned char az) {
    ...
    int x, y, z;
    int tx, ty, tz;
    int sin_x = ISIN(ax); int cos_x = ICOS(ax);
    int sin_y = ISIN(ay); int cos_y = ICOS(ay);
    int sin_z = ISIN(az); int cos_z = ICOS(az);
...
int main(void) {
    unsigned char ang_x = 0;
    unsigned char ang_y = 0;
    unsigned char ang_z = 0;
    unsigned char i, j;
